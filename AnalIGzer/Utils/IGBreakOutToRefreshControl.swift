//
//  IGBreakOutToRefreshControl.swift
//  AnalIGzer
//
...
@objc public protocol IGBreakOutToRefreshDelegate: class {
    func refreshViewDidRefresh(_ refreshView: IGBreakOutToRefreshView)
}

open class IGBreakOutToRefreshView: SKView {
    ...
    @objc open weak var refreshDelegate: IGBreakOutToRefreshDelegate?
...
extension IGBreakOutToRefreshView: UIScrollViewDelegate {
